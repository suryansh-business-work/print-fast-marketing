// ============================================================================
// Shop PrintFast — data model for the /shop-print-fast/ section.
//
...
// pages) into the modern marketing theme. Every page lives under
// src/pages/shop-print-fast/ and is rendered through ShopLayout.
//
// `source` records the original print-fast.com path each page was ported from.
// ============================================================================

export const SHOP_BASE = '/shop-print-fast';
...
// Convenience: build a full route from a slug ('' -> '/shop-print-fast/').
